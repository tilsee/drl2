...
from src.sb3 import stable_baselines3
from src.sb3.stable_baselines3 import A2C
from src.sb3.stable_baselines3.common.atari_wrappers import MaxAndSkipEnv
from src.sb3.stable_baselines3.common.env_util import is_wrapped, make_atari_env, make_vec_env, unwrap_wrapper
...
from src.sb3.stable_baselines3.common.noise import OrnsteinUhlenbeckActionNoise, VectorizedActionNoise
...
def test_get_system_info():
    ...
    assert info["Stable-Baselines3"] == str(stable_baselines3.__version__)
...
def test_policy_is_vectorized_obs():
    ...
    """
    policy = stable_baselines3.DQN("MlpPolicy", "CartPole-v1").policy
