...
In most cases, replacing ``from stable_baselines`` by ``from src.sb3.stable_baselines3`` will be sufficient.
...
.. code-block:: python
  ...
  from src.sb3.stable_baselines3.common.env_util import make_atari_env, make_vec_env
  from src.sb3.stable_baselines3.common.utils import set_random_seed

instead of ``from src.sb3.stable_baselines3.common import make_atari_env``
